...
export default function Projetos() {
    ...
    const baseProjetos = [
        ...
        {nome: "Aplicativo de dosagem de remédio", descricao: "Um app que fornece q capacidade de calcular a dosagem de remédios, baseado no peso e na altura do paciente. Ele também conta com um conversor de medidas", link: "https://github.com/GiantMazelliWasHere/HC-Challenge-Sprint_3-Python"} 
    ]
